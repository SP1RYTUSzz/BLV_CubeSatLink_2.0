...
*/
    ...
    while (true) {
        ...
        spi_write_read_blocking(spi_default, SPI0_send_char, UART0_tx_char, 1);
        spi_write_read_blocking(spi_default, SPI1_send_char, UART1_tx_char, 1); //flipped cus UART rx is SPI tx
